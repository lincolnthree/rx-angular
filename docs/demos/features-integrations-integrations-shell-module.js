...
const SHOWCASES_ROUTES = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | pokemon-pagination-pokemon-pagination-module */[__webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~basics-tutorial-basics-module~e~b377fdfa"), __webpack_require__.e("default~basics-tutorial-basics-module~comparison-comparison-module~error-handling-error-handing-modu~ae155b61"), __webpack_require__.e("default~pokemon-pagination-pokemon-pagination-module~state-rx-state-module"), __webpack_require__.e("pokemon-pagination-pokemon-pagination-module")]).then(__webpack_require__.bind(null, /*! ./pokemon-pagination/pokemon-pagination.module */ "+pKM")).then((m) => m.PokemonPaginationModule),
    },
];
