...
const ROUTES = [
    ...
    {
        path: 'memo',
        loadChildren: () => Promise.all(/*! import() | memo-poc-memo-poc-module */[__webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~error-handling-rx-for-error-han~20405b36"), __webpack_require__.e("default~global-order-global-order-module~lazy-loading-components-lazy-loading-components-module~list~7a0a999e"), __webpack_require__.e("common"), __webpack_require__.e("memo-poc-memo-poc-module")]).then(__webpack_require__.bind(null, /*! ./memo-poc/memo-poc.module */ "n0z8")).then(m => m.MemoPocModule)
    },
    {
        path: 'pipe',
