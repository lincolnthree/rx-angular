...
const ROUTES = [
    ...
    {
        path: 'rx-base-state',
        loadChildren: () => Promise.all(/*! import() | state-rx-state-module */[__webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~basics-tutorial-basics-module~e~b377fdfa"), __webpack_require__.e("default~pokemon-pagination-pokemon-pagination-module~state-rx-state-module"), __webpack_require__.e("state-rx-state-module")]).then(__webpack_require__.bind(null, /*! ./state/rx-state.module */ "cDpE")).then((mod) => mod.RxStateModule),
        canActivate: [],
        canActivateChild: []
    },
    {
    ...
    {
        path: 'input-bindings',
        loadChildren: () => Promise.all(/*! import() | input-bindings-input-bindings-module */[__webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~basics-tutorial-basics-module~e~b377fdfa"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~coalescing-coalescing-module~gl~ed34bbde"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~error-handling-rx-for-error-han~20405b36"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~error-handling-rx-for-error-han~8dfbf23a"), __webpack_require__.e("input-bindings-input-bindings-module")]).then(__webpack_require__.bind(null, /*! ./input-bindings/input-bindings.module */ "f1zv")).then((m) => m.InputBindingsModule)
    },
    {
        path: 'decorators',
