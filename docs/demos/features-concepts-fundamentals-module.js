...
const ROUTES = [
    ...
    {
        path: 'passing-values',
        loadChildren: () => Promise.all(/*! import() | passing-values-passing-values-module */[__webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~basics-tutorial-basics-module~e~b377fdfa"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~coalescing-coalescing-module~gl~ed34bbde"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~error-handling-rx-for-error-han~20405b36"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~error-handling-rx-for-error-han~8dfbf23a"), __webpack_require__.e("default~global-order-global-order-module~lazy-loading-components-lazy-loading-components-module~list~7a0a999e"), __webpack_require__.e("default~list-actions-list-actions-module~nested-component-structure-nested-component-structure-modul~14685a13"), __webpack_require__.e("passing-values-passing-values-module")]).then(__webpack_require__.bind(null, /*! ./passing-values/passing-values.module */ "YqiD")).then(m => m.PassingValuesModule)
    },
    {
        path: 'zone-patched-apis',
        loadChildren: () => Promise.all(/*! import() | zone-patched-apis-zone-patched-apis-module */[__webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~basics-tutorial-basics-module~e~b377fdfa"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~coalescing-coalescing-module~gl~ed34bbde"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~error-handling-rx-for-error-han~20405b36"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~error-handling-rx-for-error-han~8dfbf23a"), __webpack_require__.e("common"), __webpack_require__.e("zone-patched-apis-zone-patched-apis-module")]).then(__webpack_require__.bind(null, /*! ./zone-patched-apis/zone-patched-apis.module */ "mklz")).then(m => m.ZonePatchedApisModule)
    },
    {
        path: 'scheduling',
