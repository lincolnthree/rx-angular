...
const ROUTES = [
    ...
    {
        path: 'basic-example',
        loadChildren: () => Promise.all(/*! import() | basic-example-basic-example-module */[__webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~basics-tutorial-basics-module~e~b377fdfa"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~coalescing-coalescing-module~gl~ed34bbde"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~error-handling-rx-for-error-han~20405b36"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~error-handling-rx-for-error-han~8dfbf23a"), __webpack_require__.e("basic-example-basic-example-module")]).then(__webpack_require__.bind(null, /*! ./basic-example/basic-example.module */ "Ccl0")).then(m => m.BasicExampleModule)
    }
];
