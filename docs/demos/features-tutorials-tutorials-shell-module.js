...
const TUTORIAL_ROUTES = [
    ...
    {
        path: 'basics',
        loadChildren: () => Promise.all(/*! import() | basics-tutorial-basics-module */[__webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~basics-tutorial-basics-module~e~b377fdfa"), __webpack_require__.e("default~basics-tutorial-basics-module~comparison-comparison-module~error-handling-error-handing-modu~ae155b61"), __webpack_require__.e("default~basics-tutorial-basics-module~comparison-comparison-module~error-handling-error-handing-modu~1004e347"), __webpack_require__.e("default~basics-tutorial-basics-module~comparison-comparison-module~pixel-priority-pixel-priority-mod~a5e67073"), __webpack_require__.e("default~basics-tutorial-basics-module~error-handling-error-handing-module~http-errors-http-error-mod~fe4d98d4"), __webpack_require__.e("basics-tutorial-basics-module")]).then(__webpack_require__.bind(null, /*! ./basics/tutorial-basics.module */ "JB58")).then(m => m.TutorialBasicsModule)
    },
];
