...
/***/ "0BZr":
/*!*********************************************************!*\
  !*** ./libs/cdk/src/lib/state/accumulateObservables.ts ***!
  \*********************************************************/
/*! exports provided: accumulateObservables */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "accumulateObservables", function() { return accumulateObservables; });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs */ "qCKp");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "kU1M");
/* harmony import */ var _zone_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../zone-less */ "2e5+");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils */ "rD3y");




const resolvedPromise = _zone_less__WEBPACK_IMPORTED_MODULE_2__["Promise"].resolve();
const resolvedPromise$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["from"])(resolvedPromise);
/**
 * @internal
 *
 * Used for typing
...
obj, durationSelector = resolvedPromise$) {
    ...
    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])((v) => v !== undefined), 
    ...
    return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["combineLatest"])(observables).pipe(
    // As combineLatest will emit multiple times for a change in multiple properties we coalesce those emissions together
    Object(_utils__WEBPACK_IMPORTED_MODULE_3__["coalesceWith"])(durationSelector), 
    // mapping array of values to object
    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((values) => values.reduce(getEntriesToObjectReducerFn(keys), {})), 
...
function setupSubscription(sourceObj, eventName, handler, subscriber, options) {
    ...
    if (isEventTarget(sourceObj)) {
        ...
        Object(_zone_checks__WEBPACK_IMPORTED_MODULE_2__["getZoneUnPatchedApi"])('addEventListener', sourceObj).call(sourceObj, eventName, handler, options);
        unsubscribe = () => Object(_zone_checks__WEBPACK_IMPORTED_MODULE_2__["getZoneUnPatchedApi"])('removeEventListener', source).call(source, eventName, handler, options);
    }
...
/***/ "9OxA":
/*!**************************************************************!*\
  !*** ./libs/cdk/src/lib/template-management/render-error.ts ***!
  \**************************************************************/
/*! exports provided: isRxRenderError, createErrorHandler, toRenderError */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isRxRenderError", function() { return isRxRenderError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createErrorHandler", function() { return createErrorHandler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toRenderError", function() { return toRenderError; });
/** @internal **/
...
/* harmony import */ var _utils_onStrategy__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/onStrategy */ "PbSv");
/* harmony import */ var _render_error__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./render-error */ "9OxA");
...
function notifyAllParentsIfNeeded(tNode, injectingViewCdRef, strategy, notifyNeeded) {
    return (o$) => o$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["delay"])(0, _zone_less_rxjs_scheduler_index__WEBPACK_IMPORTED_MODULE_3__["asyncScheduler"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])((v) => {
        ...
        behaviors.push(Object(_utils_onStrategy__WEBPACK_IMPORTED_MODULE_4__["onStrategy"])(null, strategy, (_v, work, options) => work(injectingViewCdRef, options.scope), { scope: injectingViewCdRef.context || injectingViewCdRef }, error => Object(_render_error__WEBPACK_IMPORTED_MODULE_5__["toRenderError"])(error, injectingViewCdRef)));
...
function notifyInjectingParentIfNeeded(injectingViewCdRef, strategy, notify) {
    return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["concat"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(null), notify
        ...
        }, {}, error => Object(_render_error__WEBPACK_IMPORTED_MODULE_5__["toRenderError"])(error, injectingViewCdRef)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["ignoreElements"])())
        : []);
}
/**
 * @internal
...
function getVirtualParentNotifications$(tNode, injectingViewCdRef, strategy) {
    ...
    for (const parentComponent of parentElements.values()) {
        ...
        }, { scope: parentComponent }, error => Object(_render_error__WEBPACK_IMPORTED_MODULE_5__["toRenderError"])(error, injectingViewCdRef)));
    }
    return behaviors;
}
...
/* harmony import */ var _render_error__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./render-error */ "9OxA");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils */ "F2kK");
...
function createTemplateManager(config) {
    ...
    const errorHandler = Object(_render_error__WEBPACK_IMPORTED_MODULE_4__["createErrorHandler"])(renderSettings.errorHandler);
    const tNode = parent
        ? Object(_utils__WEBPACK_IMPORTED_MODULE_5__["getTNode"])(injectingViewCdRef, eRef.nativeElement)
        : false;
    let activeTemplate;
    ...
    const templates = Object(_utils__WEBPACK_IMPORTED_MODULE_5__["templateHandling"])(templateSettings.viewContainerRef);
    ...
    return {
        ...
        render(values$) {
            ...
            Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(([notification, strategy]) => {
                ...
                ).pipe(Object(_utils__WEBPACK_IMPORTED_MODULE_5__["notifyAllParentsIfNeeded"])(tNode, injectingViewCdRef, strategy, () => notifyParent)), Object(_utils__WEBPACK_IMPORTED_MODULE_5__["notifyInjectingParentIfNeeded"])(injectingViewCdRef, strategy, isNewTemplate).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["ignoreElements"])())).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])((e) => {
...
class RxFor {
    ...
    ngOnInit() {
        ...
        this._subscription = this.listManager.render(this.values$).subscribe(v => { var _a; return (_a = this._renderCallback) === null || _a === void 0 ? void 0 : _a.next(v); });
    }
    /** @internal */
...
/* harmony import */ var _utils_onStrategy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/onStrategy */ "PbSv");
/* harmony import */ var _utils_strategy_handling__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/strategy-handling */ "6+wS");
/* harmony import */ var _list_view_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./list-view-handler */ "enTY");
/* harmony import */ var _render_error__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./render-error */ "9OxA");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils */ "F2kK");
...
function createListTemplateManager(config) {
    ...
    const { defaultStrategyName, strategies, cdRef: injectingViewCdRef, patchZone, parent, eRef, } = renderSettings;
    const errorHandler = Object(_render_error__WEBPACK_IMPORTED_MODULE_5__["createErrorHandler"])(renderSettings.errorHandler);
    const strategyHandling$ = Object(_utils_strategy_handling__WEBPACK_IMPORTED_MODULE_3__["strategyHandling"])(defaultStrategyName, strategies);
    const differ = iterableDiffers.find([]).create(trackBy);
    //               type,  context
    const tNode = parent
        ? Object(_utils__WEBPACK_IMPORTED_MODULE_6__["getTNode"])(injectingViewCdRef, eRef.nativeElement)
        : false;
    ...
    const listViewHandler = Object(_list_view_handler__WEBPACK_IMPORTED_MODULE_4__["getTemplateHandler"])(Object.assign(Object.assign({}, templateSettings), { initialTemplateRef: templateSettings.templateRef, patchZone }));
    const viewContainerRef = templateSettings.viewContainerRef;
    ...
    function render() {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(([{ changes, items }, strategy]) => {
            ...
            Object(_utils__WEBPACK_IMPORTED_MODULE_6__["notifyAllParentsIfNeeded"])(tNode, injectingViewCdRef, strategy, () => notifyParent)), 
            // emit injectingParent if needed
            Object(_utils__WEBPACK_IMPORTED_MODULE_6__["notifyInjectingParentIfNeeded"])(injectingViewCdRef, strategy, insertedOrRemoved).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["ignoreElements"])())).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(() => items), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])((e) => {
    ...
    function getObservablesFromChangesArray(changes, strategy, count) {
        return changes.length > 0
            ? changes.map((change) => {
                return Object(_utils_onStrategy__WEBPACK_IMPORTED_MODULE_2__["onStrategy"])(change[1], strategy, () => {
                    const type = change[0];
                ...
                }, {}, (e, v) => Object(_render_error__WEBPACK_IMPORTED_MODULE_5__["toRenderError"])(e, v[0]));
            })
 ...
 * @param errorFactory
 */
function onStrategy(value, strategy, workFactory, options = {}, errorFactory = (e, v) => [e, v]) {
    let error;
    return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(value).pipe(strategy.behavior(() => {
        try {
            workFactory(value, strategy.work, options);
        }
        catch (e) {
    ...
    }, options.scope || {}), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["switchMap"])(() => error ? Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["throwError"])(errorFactory(error, value)) : Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(value)));
}
...
function setupSubscription(sourceObj, eventName, handler, subscriber, options) {
    ...
    if (isEventTarget(sourceObj)) {
        const source = sourceObj;
        Object(_utils__WEBPACK_IMPORTED_MODULE_2__["getZoneUnPatchedApi"])('addEventListener', sourceObj).call(sourceObj, eventName, handler, options);
        unsubscribe = () => Object(_utils__WEBPACK_IMPORTED_MODULE_2__["getZoneUnPatchedApi"])('removeEventListener', source).call(source, eventName, handler, options);
    }
    else if (isJQueryStyleEventEmitter(sourceObj)) {
        const source = sourceObj;
        sourceObj.on(eventName, handler);
...
function rxMaterialize() {
    return (o$) => o$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["materialize"])(), 
    /*tap(({ kind, error }) => {
      if (kind === 'E') {
        console.error(error);
      }
 ...
 */
class RxLet {
    constructor(strategyProvider, cdRef, eRef, ngZone, nextTemplateRef, viewContainerRef, errorHandler) {
        this.strategyProvider = strategyProvider;
        this.cdRef = cdRef;
        this.eRef = eRef;
        this.ngZone = ngZone;
...
RxLet.ɵfac = function RxLet_Factory(t) { return new (t || RxLet)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_rx_angular_cdk__WEBPACK_IMPORTED_MODULE_2__["RxStrategyProvider"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["ErrorHandler"])); };
...
/* harmony import */ var _lib_state__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./lib/state */ "t3SD");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "accumulateObservables", function() { return _lib_state__WEBPACK_IMPORTED_MODULE_7__["accumulateObservables"]; });
...
/***/ "t3SD":
/*!*****************************************!*\
  !*** ./libs/cdk/src/lib/state/index.ts ***!
  \*****************************************/
/*! exports provided: accumulateObservables */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _accumulateObservables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./accumulateObservables */ "0BZr");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "accumulateObservables", function() { return _accumulateObservables__WEBPACK_IMPORTED_MODULE_0__["accumulateObservables"]; });
