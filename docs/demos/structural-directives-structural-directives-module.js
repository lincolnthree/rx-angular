...
const ROUTES = [
    ...
    {
        path: 'rx-switch-poc',
        loadChildren: () => Promise.all(/*! import() | rx-switch-poc-rx-switch-poc-module */[__webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~basics-tutorial-basics-module~e~b377fdfa"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~coalescing-coalescing-module~gl~ed34bbde"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~error-handling-rx-for-error-han~20405b36"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~error-handling-rx-for-error-han~8dfbf23a"), __webpack_require__.e("default~global-order-global-order-module~lazy-loading-components-lazy-loading-components-module~list~7a0a999e"), __webpack_require__.e("rx-switch-poc-rx-switch-poc-module")]).then(__webpack_require__.bind(null, /*! ./rx-switch-poc/rx-switch-poc.module */ "/DVU")).then((m) => m.RxSwitchPocModule),
    },
    {
        path: 'if-visible',
        loadChildren: () => Promise.all(/*! import() | if-visible-poc-if-visible-routed-module */[__webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~basics-tutorial-basics-module~e~b377fdfa"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~coalescing-coalescing-module~gl~ed34bbde"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~error-handling-rx-for-error-han~20405b36"), __webpack_require__.e("default~basic-example-basic-example-module~basic-rx-let-basic-module~error-handling-rx-for-error-han~8dfbf23a"), __webpack_require__.e("if-visible-poc-if-visible-routed-module")]).then(__webpack_require__.bind(null, /*! ./if-visible-poc/if-visible-routed.module */ "COOv")).then((m) => m.IfVisibleRoutedModule),
    },
];
